...
const footnotes_marked_1 = require("./footnotes.marked");
marked_1.marked.use({
    renderer: {
...
marked_1.marked.use({
    extensions: [
        callout_marked_1.calloutExtension,
        math_block_marked_1.mathBlockExtension,
        math_inline_marked_1.mathInlineExtension,
        footnotes_marked_1.footnoteDefExtension,
        footnotes_marked_1.footnoteRefExtension,
    ],
});
...
function markdownToHtml(markdownInput) {
    ...
    const markdown = markdownInput
        ...
        .trimStart();
    (0, footnotes_marked_1.resetFootnotes)();
    const html = marked_1.marked.parse(markdown).toString();
    return html + (0, footnotes_marked_1.renderFootnotesList)();
}
